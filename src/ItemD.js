 ...
 import ArtSelec from "./ItemContenedorDateil.js"
...
const ImprDateil = () =>{
    return(
        <>
         ...
         <div className="contenedorID">
              <h3 className="pLL">Significado del oro rosa</h3>
         ...
         <div className="contenedorID">
            <h3 className="pLL">¿Qué es el oro rosa?</h3>
          ...
          <div className="contenedorID">
           <h3  className="pLL">Origen del metal oro rosa</h3>
