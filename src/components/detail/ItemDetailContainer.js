...
const ItemDetailConteiner = () => {
  ...
  return (
    <>
      ...
      <div className="contend_detail">
        <div>
          <ItemDetail articulo={articulo} />
        </div>
        <div className="contenedor_id">
          <h3 className="titulo_detail">Significado del oro rosa</h3>
        ...
        <div className="contenedor_id">
          <h3 className="titulo_detail">¿Qué es el oro rosa?</h3>
        ...
        <div className="contenedor_id">
          <h3 className="titulo_detail">Origen del metal oro rosa</h3>
